# Operator Quickstart — Beverage Serving Activities

Shortest path from clone to a verified local dry-run for **ISIC 5630** (`cloud-itonami-isic-5630`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5630.git
cd cloud-itonami-isic-5630
```
...
- Blueprint governor key: `beverage-service-governor`
- Likely source path: `beverageops.governor.cljc`
